...
1. 微信pc端扫码登录如何实现
    - 如何确定当前登录的是你的pc
    - long poll 超时如何判断，超时多少
    - token如何传，如何解
    - c10k、c1m、c10m？
2. tcp和udp啥区别
    - udp是双工吗？
    - tcp为啥三次握手，两次不行吗？为啥不行
    - 流水号怎么算的，会不会出现流水号过大、多大会溢出、溢出会怎样
    - udp如何通信、你什么时候用了udp、udp 分片能大概说下嘛
    - 为啥你说tcp有序，udp没有嘛？能举个例子吗？
...
6. electron会吗？
7. 文件操作熟吗？竞态？I/O独占如何实现？你知道几种，优缺点呢
【编程】大致写下你说的询问锁和强制锁。主要思路？
8. ...
9. 说说你为什么想做node相关
